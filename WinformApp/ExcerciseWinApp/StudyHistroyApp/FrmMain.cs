...
namespace StudyHistroyApp
{
    public partial class FrmMain : Form
    {
        ...
        private void TrvList_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            if (e.Node.Name == "앤(1707~1714) ")
            {
                PcbPhoto.Image = Bitmap.FromFile(@"C:\Users\mini2\Desktop\Study Repository\StudyDesktopApp\WinformApp\ExcerciseWinApp\StudyHistroyApp\Images/Anne.jpg");
            ...
            else if (e.Node.Name == "조지 1세(1714~1727)")
            {
                PcbPhoto.Image = Bitmap.FromFile(@"C:\\Users\\mini2\\Desktop\\Study Repository\\StudyDesktopApp\\WinformApp\\ExcerciseWinApp\\StudyHistroyApp\\Images/King_George_I.jpg");
                TxtDescription.Text = "조지 1세는 1702년 3월 8일 잉그랜드와 스코틀랜드, , " +
                    "Lorem ipsum dolor sit amet consectetur adipisicing elit. " +
                    "Consequatur qui eum rem assumenda quia, ut repudiandae deleniti " +
                    "laborum nemo veniam optio quisquam earum aperiam esse soluta " +
                    "eligendi unde dolore impedit.";
